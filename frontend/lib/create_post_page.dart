...
class _CreatePostPageState extends State<CreatePostPage> {
  ...
  Widget _buildSelectableChips(List<String> options, List<String> selectedList, Function(String) onTap) {
    return Wrap(
      spacing: 8,
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: "Describe your feelings and how the community can support you...",
                border: OutlineInputBorder(),
              ),
            ),
            SizedBox(height: 16),
            ...
            // Select Mood
            Text("Select Your Mood", style: TextStyle(fontWeight: FontWeight.bold)),
            Wrap(
              spacing: 8,
            ...
            Text("Type of Support Needed", style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            // Media File Picker
            Text("Add Photos or Videos", style: TextStyle(fontWeight: FontWeight.bold)),
            ElevatedButton.icon(
              onPressed: pickFile,
            ...
            Row(
              ...
              children: [
                Text("Post Visibility", style: TextStyle(fontWeight: FontWeight.bold)),

  ...
  void _showTherapistDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Connect with licensed mental health professionals in your area.'),
        actions: [
          TextButton(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Column(
          ...
          children: [
            ...
            Text('1-800-273-8255', style: TextStyle(fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
  ...
  void _showSamhsaDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Substance Abuse and Mental Health Services Administration\n\n1-800-662-4357'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('Close'),
  ...
  void _showCopingDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('• Deep breathing exercises\n• Mindfulness meditation\n• Regular exercise\n• Healthy sleep schedule\n• Connect with friends and family'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('Close'),
